...
internal class LinqFilter
{
    ...
    public static void ListaDeMusicasPorTonalidade(List<Musica> musicas)
    {
        var musicasPorTonalidade = musicas.Where(musicas => musicas.Tonalidade.Equals("C#")).Select(musicas => musicas.Nome).ToList();
